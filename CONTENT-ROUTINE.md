...
- ✅ **Snook Sept 1 reopening** — post **331** reframed 2026-08-29 from "closed, release only" to the
  opener. FWC-verified that day: **7 of 9 regions open Sept 1**; **Charlotte Harbor and Southwest
  (incl. all waters of Everglades NP) stay closed until Oct 1**. Slots 28–33″ Gulf / 28–32″ Atlantic,
  1/person/day, snook permit required. `lib/regs.js` already encodes this correctly — **don't
  re-derive it, and don't "simplify" the Gulf into one May 1–Aug 31 window.** Next snook date that
  matters: **Oct 1**, Charlotte Harbor / Southwest.
...
| ~~6~~ | ~~**Fishing Knots That Actually Matter**~~ | ~~evergreen~~ | ✅ **DONE 2026-08-21 — post 1458** (`/fishing-knots-florida-saltwater/`). setup preset `inshore-allround` (`keep`); Salt Strong FG-knot video (channel oembed-verified). Down-links from 40, 383, 550, 141. This is now the internal-link glue the queue predicted — point new gear and species posts at it |
